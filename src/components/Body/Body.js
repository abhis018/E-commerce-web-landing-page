...
class Body extends Component{
    ...
    onChange= (event) =>  {
        this.setState({
            ...
            this.props.filterProduct(this.state.priceFilter, this.state.ratingFilter);
         })
    }
                ...
                <div className="sale">
                    <div className="filter">
                        ...
                        <div className="review">
                            <button onClick={this.onChange} name="ratingFilter" value="equalto5">&#9733; &#9733; &#9733; &#9733; &#9733;</button><br/>
                            <button onClick={this.onChange} name="ratingFilter" value="greaterthan4">&#9733; &#9733; &#9733; &#9733; &#9734;</button><br/>
                            <button  onClick={this.onChange}name="ratingFilter" value="greaterthan3">&#9733; &#9733; &#9733; &#9734; &#9734;</button><br/>
