...
const filterType = {
    pricefilter: {
        ...
        'between4001&10000' : 'between4001&10000',
        'between2501&4000' : 'between2501&4000',
        'between1001&2500' : 'between1001&2500',
    ...
    for(let i=0; i<product.length; i++){
        switch(pricefilter) {
            case filterType.pricefilter.greaterthan10000:
                ...
                break;
            case filterType.pricefilter.between4001&10000:
                if(product[i].price > 4000 & product[i].price <= 10000){
                    res.push(product[i]);
                }
                break;
            case filterType.pricefilter.between2501&4000:
                if(product[i].price > 2501 & product[i].price <= 4000) {
                    res.push(product[i]);
                }
                break;
            case filterType.pricefilter.between1001&2500:
